...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::DependencyProperty) AutomationControlTypeProperty() const;
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::Xaml::Automation::Peers::AutomationControlType) GetAutomationControlType(winrt::Microsoft::UI::Xaml::UIElement const& element) const;
        WINRT_IMPL_AUTO(void) SetAutomationControlType(winrt::Microsoft::UI::Xaml::UIElement const& element, winrt::Microsoft::UI::Xaml::Automation::Peers::AutomationControlType const& value) const;
    };
