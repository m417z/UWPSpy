...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Microsoft::UI::Composition::SystemBackdrops::DesktopAcrylicKind) Kind() const;
        WINRT_IMPL_AUTO(void) Kind(winrt::Microsoft::UI::Composition::SystemBackdrops::DesktopAcrylicKind const& value) const;
    };
