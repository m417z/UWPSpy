...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(hstring) GetSddlForAppContainerNames(array_view<winrt::Microsoft::Windows::Security::AccessControl::AppContainerNameAndAccess const> accessRequests, param::hstring const& principalStringSid, uint32_t principalAccessMask) const;
        WINRT_IMPL_AUTO(com_array<uint8_t>) GetSecurityDescriptorBytesFromAppContainerNames(array_view<winrt::Microsoft::Windows::Security::AccessControl::AppContainerNameAndAccess const> accessRequests, param::hstring const& principalStringSid, uint32_t principalAccessMask) const;
    };
