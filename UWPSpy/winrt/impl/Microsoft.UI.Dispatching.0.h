...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(void) EnqueueEventLoopExit() const;
        WINRT_IMPL_AUTO(void) EnsureSystemDispatcherQueue() const;
        WINRT_IMPL_AUTO(void) RunEventLoop() const;
        WINRT_IMPL_AUTO(void) RunEventLoop(winrt::Microsoft::UI::Dispatching::DispatcherRunOptions const& options, winrt::Microsoft::UI::Dispatching::DispatcherExitDeferral const& deferral) const;
        WINRT_IMPL_AUTO(winrt::event_token) FrameworkShutdownStarting(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Dispatching::DispatcherQueue, winrt::Microsoft::UI::Dispatching::DispatcherQueueShutdownStartingEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) FrameworkShutdownStarting(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) FrameworkShutdownCompleted(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::Dispatching::DispatcherQueue, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) FrameworkShutdownCompleted(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) ShutdownQueue() const;
    };
