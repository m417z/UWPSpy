...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) Changed(winrt::Windows::Foundation::TypedEventHandler<winrt::Microsoft::UI::System::ThemeSettings, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Microsoft::UI::System::ThemeSettings) CreateForWindowId(winrt::Microsoft::UI::WindowId const& windowId) const;
    };
